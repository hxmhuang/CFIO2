...
int main(int argc, char** argv)
{
    ...
    char var_name[16];
    int var[VALN];
    double compute_time = 0.0, IO_time = 0.0, waitwrite_time = 0.0, itr_time = 0.0;
...
//    printf("proc %d waitwrite time : %f\n", rank, waitwrite_time);
//    printf("proc %d total time : %f\n", rank, times_end());
    printf("proc %2d co| IO| ww| it| to: %8d %8d %8d %8d %8d\n", 
	    rank, (int)compute_time, (int)IO_time, (int)waitwrite_time, (int)itr_time, (int)times_end());
