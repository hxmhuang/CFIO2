...
#sed -i "s!.*#define SLEEP_TIME .*!#define SLEEP_TIME 1!g" $rdma_test_def
cp /home/hxm/zc/expr/src/imitate.perform_test.c $rdma_test_dir/perform_test.c
cp /home/hxm/zc/expr/src/imitate.perform_test_pnetcdf.c $rdma_test_dir/perform_test_pnetcdf.c
...
cp /home/hxm/zc/expr/src/imitate.perform_test.c $cfio_test_dir/perform_test.c
...
while [ $RATIO -gt 0 ]; do
	...
	cd $rdma_test_dir
	out_file_name="pt-out/imitate/imitate-rdma"
	...
	cd $cfio_test_dir
	out_file_name="pt-out/imitate/imitate-cfio"
	repeat # call function
    fi
	...
	cd $rdma_test_dir
	out_file_name="pt-out/imitate-pnf/imitate-pnf"
